...
def get_transport_collector_config() -> TransportCollectorConfig:
    """Get typed transport collector configuration section."""
    return get_typed_config().transport_collector
